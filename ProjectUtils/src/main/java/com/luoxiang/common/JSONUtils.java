 ...
 * @createTime:2014年11月10日 下午3:14:59
 * @author:肖震
 * @version 1.0.0
 *
 */
public class JSONUtils {
	...
	public static String toJSONStringFromMap(Map<String,String> argMap) {
		Gson   gson    = new Gson();
		String jsonStr = gson.toJson(argMap);
		return jsonStr;
	}
	...
	/***
	 * 将List或者数组对象序列化为JSON文本，或者单个实体BEAN转换成数组json格式
	 */
	public static <T> String toJSONArrayStringExtraNull(Object object) {
	 ...
	 * @throws Exception
	 */
	public static <T> T toBean(String jsonString, Class<T> clz) throws Exception {
		JSONObject jsonObject = JSONObject.fromObject(jsonString);
		T entity = JSONUtils.toBean(jsonObject, clz);
		return entity;
	}
